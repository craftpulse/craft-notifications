...
/**
 * Notifications en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('notifications', '...')`) as
 ...
 */
return [
    'Notifications plugin loaded' => 'Notifications plugin loaded',
];
